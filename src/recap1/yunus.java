...
3 farkli odeme imkani sunun
        */
        ...
        soyad = soyad.replaceAll(" ", "qwea");//adda olan boslugu "qwea" ile degistirdim replaceAll kullanirken silinmesinler diye
        ...
        String kisaltilmisYas;//yas icin ayri bir degisken atadim mecbur if in disina yazdim asagida aciklayacagim
        if (aSoyad == bSoyad) {//eger aSoyad bSoyada esit ise program calismaya devam edicek (else en asagida)
            soyad = soyad.replaceAll("qwea", " ");//"qwea"yi tekrar bosluk yaptim problem cikmasin diye
                ...
                if (yasString.equals(kisaltilmisYas)) {//eger yasString ile kisaltilmisYas stringleri birbirine esitse  (else en asagida)
                    ...
                    if (!((yas > 100) || (yas < 0))) {//eger yas yuzden buyuk ya da 0dan kucuk degilse (else en asagida)
                        ...
                        System.out.print(bosluk + "\nIstediginiz arac ehliyetinin numarasini giriniz\n1. Araba\n2. Motorsiklet\n3. Ucak\n4. Gemi "+
                                bosluk+"\nAraba ehliyeti icin 18 ve ustu\nMotor ehliyeti icin 16 yas ve ustu\nGemi ehliyeti icin 20 yas ve ustu\nUcak ehliyeti icin 22 yas ve ustu olmaniz gerekli"+bosluk+"\nNumara:");
